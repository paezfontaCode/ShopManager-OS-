  ...
  return (
    <div className="bg-white dark:bg-dark-card p-6 rounded-lg shadow-md">
      ...
      <Modal
        ...
        title={currentPart ? 'Edit Part' : 'Add New Part'}
      >
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Compatible Models (comma separated)</label>
            <input
              type="text"
              name="compatible_models"
              value={formData.compatible_models}
              onChange={handleInputChange}
              placeholder="iPhone 11, iPhone 12, etc."
              className="w-full px-3 py-2 border rounded-lg dark:bg-dark-bg dark:border-gray-600 focus:ring-primary focus:border-primary"
            />
          </div>
